...
Page({
  ...
  _setShareData(){
    ...
    wareData = {
      productName: ware.wareList.length && ware.wareList[0].productName,
      productKeyword: ware.wareList.length && ware.wareList[0].productKeyword,
      coverPath: ware.wareList.length && ware.wareList[0].coverPath,
      clickCount: ware.wareList.length && ware.wareList[0].clickCount,
      productTypeId: ware.wareList.length && ware.wareList[0].productTypeId,
      riskLev: ware.wareList.length && ware.wareList[0].riskLev,
      investmentHorizon: ware.wareList.length && ware.wareList[0].investmentHorizon,
      minimumAmount: ware.wareList.length && ware.wareList[0].minimumAmount,
